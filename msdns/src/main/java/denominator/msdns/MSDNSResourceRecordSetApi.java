...
final class MSDNSResourceRecordSetApi implements denominator.ResourceRecordSetApi {

  private final MSDNSAllProfileResourceRecordSetApi delegate;

  MSDNSResourceRecordSetApi(String zoneName) {
    this.delegate = new MSDNSAllProfileResourceRecordSetApi(zoneName, alwaysVisible());
  }
