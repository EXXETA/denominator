...
class MSDNSAllProfileResourceRecordSetApi implements denominator.AllProfileResourceRecordSetApi {

  private final String zoneName;
  private final Filter<ResourceRecordSet<?>> filter;

  MSDNSAllProfileResourceRecordSetApi(String zoneName, Filter<ResourceRecordSet<?>> filter) {
  ...
  Collection<ResourceRecordSet<?>> records() {
    Collection<ResourceRecordSet<?>> result = null;
